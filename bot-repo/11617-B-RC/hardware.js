...
function createServoControllerDropdown() {
  var CHOICES = [
      ['Expansion Hub 1', 'ExpansionHub1AsServoController'],
...
function createVoltageSensorDropdown() {
  var CHOICES = [
      ['Expansion Hub 1', 'ExpansionHub1AsVoltageSensor'],
...
function addReservedWordsForJavaScript() {
  ...
  Blockly.JavaScript.addReservedWords('ExpansionHub1AsREVModule');
  Blockly.JavaScript.addReservedWords('ExpansionHub1AsServoController');
  Blockly.JavaScript.addReservedWords('ExpansionHub1AsVoltageSensor');
...
function getHardwareItemDeviceName(identifier) {
  switch (identifier) {
    ...
    case 'ControlHubAsVoltageSensor':
      return 'Control Hub';
    case 'ExpansionHub1AsREVModule':
      return 'Expansion Hub 1';
    case 'ExpansionHub1AsServoController':
      return 'Expansion Hub 1';
    case 'ExpansionHub1AsVoltageSensor':
      return 'Expansion Hub 1';
...
function getHardwareItemIdentifierForFtcJava(identifier) {
  switch (identifier) {
    ...
    case 'ExpansionHub1AsREVModule':
      return 'ExpansionHub1';
    case 'ExpansionHub1AsServoController':
      return 'ExpansionHub1_ServoController';
    case 'ExpansionHub1AsVoltageSensor':
      return 'ExpansionHub1_VoltageSensor';
    case 'back_left_motorAsDcMotor':
      return 'back_left_motor';
    case 'back_right_motorAsDcMotor':
      return 'back_right_motor';
...
function addReservedWordsForFtcJava() {
  ...
  Blockly.FtcJava.addReservedWords(getHardwareItemIdentifierForFtcJava('ExpansionHub1AsREVModule'));
  Blockly.FtcJava.addReservedWords(getHardwareItemIdentifierForFtcJava('ExpansionHub1AsServoController'));
  Blockly.FtcJava.addReservedWords(getHardwareItemIdentifierForFtcJava('ExpansionHub1AsVoltageSensor'));
