...
;
Blockly.JavaScript.scrub_ = function(block, code, nextCode) {
    var commentCode = "";
    if (!block.outputConnection || !block.outputConnection.targetConnection) {
        var comment = block.getCommentText();
        comment = Blockly.utils.string.wrap(comment, Blockly.JavaScript.COMMENT_WRAP - 3);
        if (comment) {
        ...
        var childBlock;
        for (var f = 0; f < block.inputList.length; f++)
            block.inputList[f].type == Blockly.INPUT_VALUE 
                && (childBlock = block.inputList[f].connection.targetBlock()) 
                && (comment = Blockly.JavaScript.allNestedComments(childBlock)) 
                && (commentCode += Blockly.JavaScript.prefixLines(comment, "// "))
    }
    var nextBlock = block.nextConnection && block.nextConnection.targetBlock();
    nextCode = nextCode ? "" : Blockly.JavaScript.blockToCode(nextBlock);
...
Blockly.JavaScript.getAdjusted = function(a, b, c, d, e) {
    ...
    if (Blockly.isNumber(a))
        ...
        if (0 < c) {
            ...
            0 > c && (a = a + " - " + -c,
            g = Blockly.JavaScript.ORDER_SUBTRACTION);
        d && (a = c ? "-(" + a + ")" : "-" + a,
...
Blockly.JavaScript.controls_for = function(a) {
    ...
    if (Blockly.isNumber(c) && Blockly.isNumber(d) && Blockly.isNumber(e)) {
        ...
        a = "",
        g = c,
        c.match(/^\w+$/) || Blockly.isNumber(c) || (g = Blockly.JavaScript.variableDB_.getDistinctName(b + "_start", Blockly.VARIABLE_CATEGORY_NAME),
        a += "var " + g + " = " + c + ";\n"),
        c = d,
        d.match(/^\w+$/) || Blockly.isNumber(d) || (c = Blockly.JavaScript.variableDB_.getDistinctName(b + "_end", Blockly.VARIABLE_CATEGORY_NAME),
        a += "var " + c + " = " + d + ";\n"),
        d = Blockly.JavaScript.variableDB_.getDistinctName(b + "_inc", Blockly.VARIABLE_CATEGORY_NAME),
        a += "var " + d + " = ",
...
Blockly.JavaScript.controls_forEach = function(a) {
    ...
    a = "";
    var e = c;
    c.match(/^\w+$/) || (e = Blockly.JavaScript.variableDB_.getDistinctName(b + "_list", Blockly.VARIABLE_CATEGORY_NAME),
    a += "var " + e + " = " + c + ";\n");
...
Blockly.JavaScript.procedures_callreturn = function(a) {
    for (var b = Blockly.JavaScript.variableDB_.getName(a.getFieldValue("NAME"), Blockly.PROCEDURE_CATEGORY_NAME), c = [], d = 0; d < a.arguments_.length; d++)
