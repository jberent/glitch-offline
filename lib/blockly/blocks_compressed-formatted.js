...
Blockly.Blocks.lists_split = {
    ...
    updateType_: function(a) {
        if (this.getFieldValue("MODE") != a) {
            ...
            var c = b.targetBlock();
            c && (b.disconnect(),
            c.isShadow() ? c.dispose() : this.bumpNeighbours_())
        }
...
Blockly.Constants.Logic.LOGIC_COMPARE_ONCHANGE_MIXIN = {
    onchange: function(a) {
        ...
        b && c && !b.outputConnection.checkType_(c.outputConnection) && (Blockly.Events.setGroup(a.group),
        a = this.prevBlocks_[0],
        a !== b && (b.unplug(),
        a && !a.isShadow() && this.getInput("A").connection.connect(a.outputConnection)),
        b = this.prevBlocks_[1],
        b !== c && (c.unplug(),
        b && !b.isShadow() && this.getInput("B").connection.connect(b.outputConnection)),
...
Blockly.Constants.Logic.LOGIC_TERNARY_ONCHANGE_MIXIN = {
    ...
    onchange: function(a) {
        ...
        if ((b || c) && d)
            for (var e = 0; 2 > e; e++) {
                var f = 1 == e ? b : c;
                f && !f.outputConnection.checkType_(d) && (Blockly.Events.setGroup(a.group),
                d === this.prevParentConnection_ ? (this.unplug(),
                d.getSourceBlock().bumpNeighbours_()) : (f.unplug(),
                f.bumpNeighbours_()),
                Blockly.Events.setGroup(!1))
            }
...
Blockly.Constants.Loops.CONTROL_FLOW_IN_LOOP_CHECK_MIXIN = {
    ...
    onchange: function(a) {
        this.workspace.isDragging && !this.workspace.isDragging() && (Blockly.Constants.Loops.CONTROL_FLOW_IN_LOOP_CHECK_MIXIN.getSurroundLoop(this) ? (this.setWarningText(null),
        this.isInFlyout || this.setEnabled(!0)) : (this.setWarningText(Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING),
    ...
    renameVarById: function(a, b) {
        ...
        if ("" == c.type) {
            ...
            for (var d = this.workspace.getVariableById(b), e = !1, f = 0; f < this.argumentVarModels_.length; f++)
                this.argumentVarModels_[f].getId() == a && (this.arguments_[f] = d.name,
...
Blockly.Blocks.procedures_mutatorcontainer = {
    ...
    onchange: function(a) {
        if (this.workspace && !this.workspace.isFlyout && (a.type == Blockly.Events.BLOCK_DELETE || a.type == Blockly.Events.BLOCK_CREATE)) {
            ...
            } else if (a.type == Blockly.Events.BLOCK_CREATE && (c = this.workspace.getBlockById(a.blockId),
            c.getField("NAME") && (d = c.getFieldValue("NAME"),
            (a = this.workspace.getVariable(d)) || (a = this.workspace.createVariable(d)),
            !c.previousConnection.isConnected() && !c.nextConnection.isConnected())))
...
Blockly.Blocks.procedures_mutatorarg = {
    ...
    validator_: function(a) {
        ...
        for (var c = this.getSourceBlock().workspace.getAllBlocks(), d = 0; d < c.length; d += 1)
            if (c[d].id != this.getSourceBlock().id && c[d].getFieldValue("NAME") == a)
                return null;
        ...
        if (b)
            if (a.join("\n") == this.arguments_.join("\n"))
                ...
                for (e = 0; e < this.arguments_.length; e++)
                    d = Blockly.Variables.getOrCreateVariablePackage(this.workspace, null, this.arguments_[e], ""),
                    this.argumentVarModels_.push(d);
                this.updateShape_();
                if (this.quarkIds_ = b)
                    for (e = 0; e < this.arguments_.length; e++)
                        d = this.quarkIds_[e],
                        d in this.quarkConnections_ && (f = this.quarkConnections_[d],
                        Blockly.Mutator.reconnect(f, this, "ARG" + e) || delete this.quarkConnections_[d]);
