...
var AUTO_TRANSITION_OPTIONS = [
  'POV drive',
  'POV drive - Backup 12-1-21',
  'POV drive- Reversed Gamepad',
];
...
function addReservedWordsForJavaScript() {
  ...
  Blockly.JavaScript.addReservedWords('carouselAsDcMotor');
  Blockly.JavaScript.addReservedWords('front_leftAsDcMotor');
  Blockly.JavaScript.addReservedWords('front_rightAsDcMotor');
  Blockly.JavaScript.addReservedWords('hand_motorAsDcMotor');
  Blockly.JavaScript.addReservedWords('imuAsBNO055IMU');
  Blockly.JavaScript.addReservedWords('lift_motorAsDcMotor');
...
function getHardwareItemDeviceName(identifier) {
  switch (identifier) {
    ...
    case 'back_rightAsDcMotor':
      return 'back_right';
    case 'carouselAsDcMotor':
      return 'carousel';
    case 'front_leftAsDcMotor':
      return 'front_left';
    case 'front_rightAsDcMotor':
      return 'front_right';
    case 'hand_motorAsDcMotor':
      return 'hand_motor';
    case 'imuAsBNO055IMU':
      return 'imu';
    case 'lift_motorAsDcMotor':
      return 'lift_motor';
  }
...
function addReservedWordsForFtcJava() {
  ...
  Blockly.FtcJava.addReservedWords(getHardwareItemIdentifierForFtcJava('carouselAsDcMotor'));
  ...
  Blockly.FtcJava.addReservedWords(getHardwareItemIdentifierForFtcJava('hand_motorAsDcMotor'));
  Blockly.FtcJava.addReservedWords(getHardwareItemIdentifierForFtcJava('imuAsBNO055IMU'));
  Blockly.FtcJava.addReservedWords(getHardwareItemIdentifierForFtcJava('lift_motorAsDcMotor'));
  Blockly.FtcJava.addReservedWords('androidAccelerometer');
  Blockly.FtcJava.addReservedWords('androidGyroscope');
  Blockly.FtcJava.addReservedWords('androidOrientation');
  Blockly.FtcJava.addReservedWords('androidSoundPool');
