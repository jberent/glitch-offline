...
function createDistanceSensorDropdown() {
  var CHOICES = [
      ['distence_left', 'distence_leftAsDistanceSensor'],
...
function addReservedWordsForJavaScript() {
  ...
  Blockly.JavaScript.addReservedWords('distence_leftAsDistanceSensor');
...
function getHardwareItemDeviceName(identifier) {
  switch (identifier) {
    ...
    case 'carausolAsDcMotor':
      return 'carausol';
    case 'distence_leftAsDistanceSensor':
      return 'distence_left';
...
function addReservedWordsForFtcJava() {
  ...
  Blockly.FtcJava.addReservedWords(getHardwareItemIdentifierForFtcJava('distence_leftAsDistanceSensor'));
