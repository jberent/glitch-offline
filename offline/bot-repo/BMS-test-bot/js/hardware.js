...
var AUTO_TRANSITION_OPTIONS = [
  ...
  'Deven and jack',
  'Encoder',
  'James and Christian test drive hub',
  'Sam op mode',
  'ServoTest',
  'Skoren test 1',
  'Skoren test 2',
...
function createDcMotorDropdown() {
  var CHOICES = [
      ['rightMotor', 'rightMotorAsDcMotor'],
      ['leftMotor', 'leftMotorAsDcMotor'],
      ['crash test dummy motor', 'crashtestdummymotorAsDcMotor'],
  ];
  return createFieldDropdown(CHOICES);
}
...
function addReservedWordsForJavaScript() {
  ...
  Blockly.JavaScript.addReservedWords('crashtestdummymotorAsDcMotor');
  Blockly.JavaScript.addReservedWords('imuAsBNO055IMU');
  Blockly.JavaScript.addReservedWords('leftMotorAsDcMotor');
  Blockly.JavaScript.addReservedWords('rightMotorAsDcMotor');
  Blockly.JavaScript.addReservedWords('servo1AsServo');
  Blockly.JavaScript.addReservedWords('touchAsTouchSensor');
...
function getHardwareItemDeviceName(identifier) {
  switch (identifier) {
    ...
    case 'colorAsREVColorRangeSensor':
      return 'color';
    case 'crashtestdummymotorAsDcMotor':
      return 'crash test dummy motor';
    case 'imuAsBNO055IMU':
      return 'imu';
    case 'leftMotorAsDcMotor':
      return 'leftMotor';
    case 'rightMotorAsDcMotor':
      return 'rightMotor';
    case 'servo1AsServo':
      return 'servo1';
    case 'touchAsTouchSensor':
      return 'touch';
  }
...
function addReservedWordsForFtcJava() {
  ...
  Blockly.FtcJava.addReservedWords(getHardwareItemIdentifierForFtcJava('crashtestdummymotorAsDcMotor'));
  Blockly.FtcJava.addReservedWords(getHardwareItemIdentifierForFtcJava('imuAsBNO055IMU'));
  Blockly.FtcJava.addReservedWords(getHardwareItemIdentifierForFtcJava('leftMotorAsDcMotor'));
  Blockly.FtcJava.addReservedWords(getHardwareItemIdentifierForFtcJava('rightMotorAsDcMotor'));
  Blockly.FtcJava.addReservedWords(getHardwareItemIdentifierForFtcJava('servo1AsServo'));
  Blockly.FtcJava.addReservedWords(getHardwareItemIdentifierForFtcJava('touchAsTouchSensor'));
  Blockly.FtcJava.addReservedWords('androidAccelerometer');
  Blockly.FtcJava.addReservedWords('androidGyroscope');
  Blockly.FtcJava.addReservedWords('androidOrientation');
  Blockly.FtcJava.addReservedWords('androidSoundPool');
